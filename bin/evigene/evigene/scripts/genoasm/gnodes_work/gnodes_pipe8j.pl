...
my $gnodes1_sam2cov="\$EVIGENES/genoasm/gnodes_sam2covtab8j.pl"; # sam2covtab8e, gnodes_sam2covtab8a for UPD21JUN
...
my $gnodes4_sumgenecov="\$EVIGENES/genoasm/gnodes_sumgenecov8j.pl"; #UPD21JUL : replaces gnodes_genescov 
...
# add maybe: cdna_bestorf.pl for sh_mrna2cds()
...
=cut
  ...
  if(UPD21OCT){
    ...
    ($gsumout)= sh_sumgenescov8j($OUTSH, $genescovtab, $chrgenetab, $crsumout, $intitle); 
...
sub sh_sumgenescov8j {
  my($OUTSH, $genexcopy, $chrgenetab, $chrsum, $lintitle)=@_;   
