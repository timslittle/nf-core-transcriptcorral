...
my ( $blasttab, $refnames, $sortblast, $outnames, $cddnames, $keepid, $blformat, $swapqt, $outformat)= ("") x 9;
my $minalign=0;
$sortblast= undef;
...
my $optok= GetOptions(
 ...
 "keepid!", \$keepid, 
 "swapqt|swaprefquery!", \$swapqt, # blasttab -query ref -db aaset change columns
 "debug!", \$DEBUG, 
 );
...
my ($nout, $outname1)= 
  blast2names( $blasttab, $refnames, $sortblast, $outnames, $cddnames, $blformat, $outformat, $swapqt );
